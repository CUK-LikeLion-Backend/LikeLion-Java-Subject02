...
public class Student {
    ...
    public static void main(String[] args) {
        ...
        try {
            student.수강하기("/Users/macbook/Desktop/LIKE_LION/HW/JAVA_2/src/main/java/ex05/input.txt");
            student.학점부여받기("자료구조", "A");
            student.학점부여받기("인공지능", "A");
            student.학점부여받기("운영체제", "A");
            student.성적산출("/Users/macbook/Desktop/LIKE_LION/HW/JAVA_2/src/main/java/ex05/output.txt");
        } catch (Exception e) {
            System.out.println("[Error] " + e.getMessage());
            e.printStackTrace();
        }
